      ...
      <section className="section">
        <div className="container">
          <div className="grid grid-2" style={{ alignItems: 'center', gap: '4rem' }}>
            ...
            <div>
              <img src="/assets/images/hero_mothers_kids_health_1773512201492.png" alt="Maternal Health Program" style={{ borderRadius: 'var(--radius-xl)', boxShadow: 'var(--shadow-lg)' }} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section section-bg">
        <div className="container">
          <div className="grid grid-2" style={{ alignItems: 'center', gap: '4rem' }}>
            ...
            <div style={{ order: 1 }}>
              <img src="/assets/images/preventive_diabetes_1773512265544.png" alt="Diabetes Screening" style={{ borderRadius: 'var(--radius-xl)', boxShadow: 'var(--shadow-lg)' }} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section">
        <div className="container">
          ...
          <div className="glass-panel" style={{ padding: '4rem', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', background: 'linear-gradient(to right, rgba(46,139,87,0.1), rgba(30,144,255,0.1))' }}>
            <img src="/assets/images/youth_champions_1773512283086.png" alt="Youth Champions" style={{ width: '100%', maxWidth: '800px', borderRadius: 'var(--radius-lg)', marginBottom: '2rem', boxShadow: 'var(--shadow-md)' }} />
